function data = static_model(theta, K, realData)
% Simulates data using the static RLWM model based on the provided parameters.
% Inputs:
...
%
% Output:
%   - data: Simulated data based on the static RLWM model.
