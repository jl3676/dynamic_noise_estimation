% This script performs model identification and evaluation for the 2-step task.
...
%    - Load behavioral data for the 2-step task.
%
...
for M1=1:size(Ms,2) % Iterate over models
    ...
    parfor subject_idx=1:num_subjects % Iterate over subjects in parallel
        ...
        for rep=1:10
            ...
            this_data = feval(model1, theta); % Simulated data based on the current model and parameters
...
sgtitle('Model identification (2-step)')
