...
% parameters using optimization methods with the dynamic model.
...
parfor it = 1:num_subjects
    ...
    theta(4) = 1 - theta(3); % recover = 1 - epsilon
...
h = sgtitle('Static data recovered by dynamic model');
h.Interpreter = 'none';

% Save the figure as PNG and SVG files
saveas(gcf, '../plots/genrec_static_dynamic.png')
saveas(gcf, '../plots/genrec_static_dynamic.svg')
