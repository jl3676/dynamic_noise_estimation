...
% Computes the latent probability trajectory for a static model.
%
% Inputs:
...
%
% Output:
%   - latent: matrix containing inferred latent engaged state and choice
...
epsilon = theta(3);            % Epsilon parameter - not used in the model
lapse = 0;                     % Probability of lapsing in an engaged state - the probability of making a random response
recover = 1;                   % Probability of returning to an engaged state after lapsing - the probability of recovering from a lapse
